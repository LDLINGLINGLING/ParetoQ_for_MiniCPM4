...
# 导入量化版本的LLaMA模型
from utils.safetrainer import SafeTrainer
...
from utils.init_param import check_nan_in_model, fix_nan_in_model,initialize_quantization_params
...
def train():
    ...
    model = fix_nan_in_model(model)[0]
    model = only_train_adapter(model, verbose=True)  # 仅训练适配器参数
