...
def setup_debug_args():
    ...
    # 模型参数
    model_args = Args()
    model_args.input_model_filename = "D:\model_best\minicpm\pretrain_model\Qwen3-0___6B"  # 修改为你的模型路径
    model_args.output_model_local_path = "D:\model_best\minicpm\pretrain_model\Qwen3-0___6B-GPTQ-Int8\model.safetensors"
    model_args.w_bits = 8  # 量化位数
    model_args.contain_weight_clip_val = False
    model_args.group_size = 128  # 分组量化大小
    model_args.enable_groupwise = True  # 启用分组量化
    model_args.gptq_model_path = "D:\model_best\minicpm\pretrain_model\Qwen3-0___6B-GPTQ-Int8\model.safetensors"
